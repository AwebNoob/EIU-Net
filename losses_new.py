...
__all__ = ['BCEDiceLoss', 'LovaszHingeLoss', 'Combined_Bce_Dice_Loss']
...
class SoftDiceLoss_1(nn.Module):
    def __init__(self, weight=None, size_average=True):
        super(SoftDiceLoss_1, self).__init__()
...
class SoftDiceLoss_New(nn.Module):
    def __init__(self, apply_nonlin=None, batch_dice=False, do_bg=True, smooth=1.):
        """
        """
        super(SoftDiceLoss_New, self).__init__()
...
class Combined_Bce_Dice_Loss(nn.Module):
    def __init__(self, aggregate="sum"):
        ...
        self.dc = SoftDiceLoss_New(apply_nonlin=torch.sigmoid)
